...
export const legacyMockData = {
  directives: [
    ...
    },
    {
      ...
      title: "重要资料线索",
      detail:
        "账号、文档、项目和重要物品不要只放在脑子里，要让别人知道去哪里找。",
    },
    {
      id: "legacy-directive-3",
      title: "希望被理解的事",
      detail:
        "有些决定不是冲动，而是长期权衡后的选择，希望后来的人不要只看表面结果。",
    },
  ],
  letters: [
    {
      ...
      theme: "感谢与解释",
      excerpt:
        "想留下的不是标准答案，而是希望你们知道，我是真的在努力把自己活明白。",
    },
    {
      id: "legacy-letter-2",
      to: "重要朋友",
      theme: "告别与祝福",
      excerpt:
        "谢谢你们在很多混乱时刻让我知道，世界上确实有人能认真听懂我在说什么。",
    },
    {
      id: "legacy-letter-3",
      to: "未来的自己",
      theme: "提醒",
      excerpt:
        "别等到失去余地才想起生活真正想要的是什么，很多话现在就可以先说。",
    },
  ],
  wishes: [
    {
