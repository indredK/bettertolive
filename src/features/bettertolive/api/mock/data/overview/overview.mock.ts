...
export const overviewMockData = {
  greeting:
    "一个把记录、情绪、关系、记忆、生命整理和未来方向放在同一张桌子上的私人空间。你可以从任何入口开始，但最后都回到“我是谁”“我为什么会这样”“我想怎样生活”。",
  dailyPulse: [
    "今天更适合诚实记录，而不是逼自己得出结论。",
    "最近的情绪波动和购物冲动都在提醒你：你真正想要的是更稳的生活结构。",
    "生命整理不是沉重页面，它更像把重要的话提前安放好。",
  ...
  recentRecords: [
    {
      ...
      kind: "情绪",
      title: "醒来时明显发紧",
      description: "这次不是突然低落，更像前几天压力没有真正退掉。",
      date: "06-03 08:20",
    },
    {
      id: "recent-2",
    ...
    },
    {
      ...
      kind: "记忆",
      title: "想起第一次自己住时的房间",
      description: "自由感和现实成本是从那时开始被绑在一起的。",
      date: "06-01 21:06",
    },
    {
      id: "recent-6",
      kind: "托付",
      title: "留给未来的自己",
      description: "别等到失去余地才想起要把重要的话说清楚。",
      date: "06-01 23:05",
    },
    {
      id: "recent-7",
